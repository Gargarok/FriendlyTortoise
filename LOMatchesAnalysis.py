...
if LAUNCH_MODE == TRYOUT_MODE :  
  tryoutMode(cursor, matchDate, LIGUE_ONE_NAME, LIGUEONE_TEAMS, MUTABLE_VARS)
elif LAUNCH_MODE == EXH_DISCOVERY_MODE :
  discMode(cursor, matchDate, LIGUE_ONE_NAME, LIGUEONE_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == MONTE_CARLO_TRYOUT_MODE :
  monteCarloMode(cursor, matchDate, LIGUE_ONE_NAME, LIGUEONE_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == PRONO_MODE :          
  pronoMode(cursor, matchDate, LIGUEONE_TEAMS, LIGUE_ONE_NAME, WEEK_MATCHES, MUTABLE_VARS)
else :
