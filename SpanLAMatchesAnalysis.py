...
if LAUNCH_MODE == TRYOUT_MODE :  
  tryoutMode(cursor, matchDate, SPANISH_LIGA_NAME, SPANISH_LIGA_TEAMS, MUTABLE_VARS)
elif LAUNCH_MODE == EXH_DISCOVERY_MODE :
  discMode(cursor, matchDate, SPANISH_LIGA_NAME, SPANISH_LIGA_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == MONTE_CARLO_TRYOUT_MODE :
  monteCarloMode(cursor, matchDate, SPANISH_LIGA_NAME, SPANISH_LIGA_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == PRONO_MODE :          
  pronoMode(cursor, matchDate, SPANISH_LIGA_TEAMS, SPANISH_LIGA_NAME, WEEK_MATCHES, MUTABLE_VARS)
else :
