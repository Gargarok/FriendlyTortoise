...
import_module("BundesLAAlgorithmConstants")
...
if LAUNCH_MODE == TRYOUT_MODE :  
  tryoutMode(cursor, matchDate, BUNDESLIGA_NAME, BUNDESLIGA_TEAMS, MUTABLE_VARS)
elif LAUNCH_MODE == EXH_DISCOVERY_MODE :
  discMode(cursor, matchDate, BUNDESLIGA_NAME, BUNDESLIGA_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == MONTE_CARLO_TRYOUT_MODE :
  monteCarloMode(cursor, matchDate, BUNDESLIGA_NAME, BUNDESLIGA_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == PRONO_MODE :          
  pronoMode(cursor, matchDate, BUNDESLIGA_TEAMS, BUNDESLIGA_NAME, WEEK_MATCHES, MUTABLE_VARS)
else :
