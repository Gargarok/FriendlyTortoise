...
if LAUNCH_MODE == TRYOUT_MODE :  
  tryoutMode(cursor, matchDate, LIGUE_TWO_NAME, LIGUETWO_TEAMS, MUTABLE_VARS)
elif LAUNCH_MODE == EXH_DISCOVERY_MODE :
  discMode(cursor, matchDate, LIGUE_TWO_NAME, LIGUETWO_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == MONTE_CARLO_TRYOUT_MODE :
  monteCarloMode(cursor, matchDate, LIGUE_TWO_NAME, LIGUETWO_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == PRONO_MODE :          
  pronoMode(cursor, matchDate, LIGUETWO_TEAMS, LIGUE_TWO_NAME, WEEK_MATCHES, MUTABLE_VARS)
else :
