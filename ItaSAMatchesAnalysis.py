...
if LAUNCH_MODE == TRYOUT_MODE :  
  tryoutMode(cursor, matchDate, ITA_SERIE_A_NAME, ITA_SERIE_A_TEAMS, MUTABLE_VARS)
elif LAUNCH_MODE == EXH_DISCOVERY_MODE :
  discMode(cursor, matchDate, ITA_SERIE_A_NAME, ITA_SERIE_A_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == MONTE_CARLO_TRYOUT_MODE :
  monteCarloMode(cursor, matchDate, ITA_SERIE_A_NAME, ITA_SERIE_A_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == PRONO_MODE :          
  pronoMode(cursor, matchDate, ITA_SERIE_A_TEAMS, ITA_SERIE_A_NAME, WEEK_MATCHES, MUTABLE_VARS)
else :
