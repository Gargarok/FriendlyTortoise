...
if LAUNCH_MODE == TRYOUT_MODE :  
  tryoutMode(cursor, matchDate, PORTUGAL_LIGA_NAME, PORTUGAL_LIGA_TEAMS, MUTABLE_VARS)
elif LAUNCH_MODE == EXH_DISCOVERY_MODE :
  discMode(cursor, matchDate, PORTUGAL_LIGA_NAME, PORTUGAL_LIGA_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == MONTE_CARLO_TRYOUT_MODE :
  monteCarloMode(cursor, matchDate, PORTUGAL_LIGA_NAME, PORTUGAL_LIGA_TEAMS, MUTABLE_VARS, 1)
elif LAUNCH_MODE == PRONO_MODE :          
  pronoMode(cursor, matchDate, PORTUGAL_LIGA_TEAMS, PORTUGAL_LIGA_NAME, WEEK_MATCHES, MUTABLE_VARS)
else :
